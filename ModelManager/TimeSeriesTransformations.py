...
class frequency_transformations():
    ...
    def monthly_eop(self,ts):
        '''
        Gives last available value for each month in data
        Args:
            ts: pd.Timeseries indexed with dates

        Returns: pd.Timeseries indexed with dates with monthly frequency
    ...
    def quarterly_eop(self, ts):
        ...
        Returns: at pd.Timeseries indexed with dates and in quarter frequency
